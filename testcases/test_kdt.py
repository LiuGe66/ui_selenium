...
#     kw.key_click("//button[contains(@data-am-loading,'{load') and text()='登录']")
#     kw.key_assert_text('//*[@class="prompt-msg"]', "登录成功")
#
#
# def test_goods_favor(user_driver, clear_favor):
#     kw = KeyWord(user_driver)
#     kw.get_page("http://shop-xo.hctestedu.com/index.php?s=/index/goods/index/id/1.html")
#     # kw.get_page(huace+"?s=/index/goods/index/id/1.html")
#     kw.key_click("//*[text()='收藏']")
#     kw.key_assert_text('//*[@class="prompt-msg"]', "收藏成功")
#
#
# def test_update_userinfo(user_driver):
#     kw = KeyWord(user_driver)
#     # kw.get_page("http://101.34.221.219:8010/?s=personal/index.html")
...
#     kw.key_click("//*[text()='保存']")
    ...
    # kw.key_assert_text('//*[@class="prompt-msg"]', "编辑成功")
...
def test_update_user_avatar(user_driver):
    ...
    kw.key_assert_text('//*[@class="prompt-msg"]', "上传成功")
